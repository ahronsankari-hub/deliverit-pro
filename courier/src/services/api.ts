...
export const bidApi = {
  submit:   (requestId: string, d: object) => api.post(`/requests/${requestId}/bids`, d),
  myBids:   () => api.get('/courier/bids'),
  withdraw: (requestId: string) => api.delete(`/requests/${requestId}/bids`),
  lowerBid: (requestId: string, newPrice: number) => api.patch(`/requests/${requestId}/bids/lower`, { newPrice }),
};
